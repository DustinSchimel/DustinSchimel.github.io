...
Use the left and right arrow keys or the A and W keys to move horizontally, and press the space bar to jump. You can use shift to attack, but at the moment it's a bit unstable if spammed.
